...
│   ├── mcp/            # MCP server — 26 tools, 7 resources, 12 prompts
│   ├── server/         # Fastify REST + WebSocket API — 52 endpoints
│   └── dashboard/      # Next.js dashboard — 18 pages

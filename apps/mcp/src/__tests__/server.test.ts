 ...
 * - All production tools are registered
 * - All production resources are registered
 * - All production prompts are registered
...
describe('MCP Server', () => {
  ...
  describe('tool registration', () => {
    it('registers exactly 35 tools', () => {
      createServer();
      expect(mockTool).toHaveBeenCalledTimes(35);
    });
    ...
    it('registers "list_experiments" tool', () => {
      createServer();
      const toolNames = mockTool.mock.calls.map(
        (call: unknown[]) => call[0],
      );
    ...
    it('registers "create_experiment" tool', () => {
      createServer();
      const toolNames = mockTool.mock.calls.map(
        (call: unknown[]) => call[0],
      );
    ...
    it('registers "export_report" tool', () => {
      createServer();
      const toolNames = mockTool.mock.calls.map(
        (call: unknown[]) => call[0],
      );
    ...
    it('registers "compare_analysis_runs" tool', () => {
      createServer();
      const toolNames = mockTool.mock.calls.map(
        (call: unknown[]) => call[0],
      );
  ...
  describe('resource registration', () => {
    it('registers exactly 13 resources', () => {
      createServer();
      expect(mockResource).toHaveBeenCalledTimes(13);
    });
    ...
    it('resources use recurrsive:// URI scheme', () => {
      ...
      expect(uris).toContain('recurrsive://experiments/active');
      expect(uris).toContain('recurrsive://experiments/results');
    });

    it('registers "experiments-active" resource', () => {
      createServer();
      const resourceNames = mockResource.mock.calls.map(
        (call: unknown[]) => call[0],
      );
      expect(resourceNames).toContain('experiments-active');
    });

    it('registers "experiments-results" resource', () => {
      createServer();
      const resourceNames = mockResource.mock.calls.map(
        (call: unknown[]) => call[0],
      );
      expect(resourceNames).toContain('experiments-results');
    });
  ...
  describe('prompt registration', () => {
    it('registers exactly 17 prompts', () => {
      createServer();
      expect(mockPrompt).toHaveBeenCalledTimes(17);
    });
    ...
    it('all 17 prompt names are unique', () => {
      createServer();
      const promptNames = mockPrompt.mock.calls.map(
        (call: unknown[]) => call[0],
      );
